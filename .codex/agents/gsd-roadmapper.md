...
Reference full template: `D:/Work/AI_Projects/KAster_CTI/.codex/get-shit-done/templates/roadmap.md`

## STATE.md Structure

Use template from `D:/Work/AI_Projects/KAster_CTI/.codex/get-shit-done/templates/state.md`.
