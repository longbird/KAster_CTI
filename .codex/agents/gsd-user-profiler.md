...
<reference>
@D:/Work/AI_Projects/KAster_CTI/.codex/get-shit-done/references/user-profiling.md
...
Read the user-profiling reference document at `D:/Work/AI_Projects/KAster_CTI/.codex/get-shit-done/references/user-profiling.md` to load:
