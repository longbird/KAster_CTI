...
@D:/Work/AI_Projects/KAster_CTI/.codex/get-shit-done/references/thinking-models-research.md
...
```bash
node "D:/Work/AI_Projects/KAster_CTI/.codex/get-shit-done/bin/gsd-tools.cjs" graphify query "<capability-keyword>" --budget 1500
```
