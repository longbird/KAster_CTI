...
<!-- For checkpoint task examples and patterns, see @D:/Work/AI_Projects/KAster_CTI/.codex/get-shit-done/references/checkpoints.md -->
...
See `D:/Work/AI_Projects/KAster_CTI/.codex/get-shit-done/references/tdd.md` for TDD plan structure.
...
See `D:/Work/AI_Projects/KAster_CTI/.codex/get-shit-done/templates/user-setup.md` for full schema and examples
...
See `D:/Work/AI_Projects/KAster_CTI/.codex/get-shit-done/workflows/verify-phase.md` for verification logic.
