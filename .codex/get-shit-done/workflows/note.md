...
- **Global scope**: `D:/Work/AI_Projects/KAster_CTI/.codex/notes/{YYYY-MM-DD}-{slug}.md` — fallback when no `.planning/`, or when `--global` flag is present
...
2. Ensure the notes directory exists (`.planning/notes/` or `D:/Work/AI_Projects/KAster_CTI/.codex/notes/`)
...
2. Glob `D:/Work/AI_Projects/KAster_CTI/.codex/notes/*.md` (if directory exists) — global notes
...
Global (D:/Work/AI_Projects/KAster_CTI/.codex/notes/):
...
2. **No `.planning/`**: Falls back to global `D:/Work/AI_Projects/KAster_CTI/.codex/notes/` — works in any directory
