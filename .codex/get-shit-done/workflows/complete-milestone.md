...
```bash
node "D:/Work/AI_Projects/KAster_CTI/.codex/get-shit-done/bin/gsd-tools.cjs" audit-open 2>/dev/null
```
...
**If doesn't exist:** Create from template at `D:/Work/AI_Projects/KAster_CTI/.codex/get-shit-done/templates/retrospective.md`.
