...
Key references:
- @D:/Work/AI_Projects/KAster_CTI/.codex/get-shit-done/references/ui-brand.md (display patterns)
- @D:/Work/AI_Projects/KAster_CTI/.codex/get-shit-done/agents/gsd-user-profiler.md (profiler agent definition)
- @D:/Work/AI_Projects/KAster_CTI/.codex/get-shit-done/references/user-profiling.md (profiling reference doc)
</required_reading>
...
```bash
PROFILE_PATH="D:/Work/AI_Projects/KAster_CTI/.codex/get-shit-done/USER-PROFILE.md"
...
```bash
cp "D:/Work/AI_Projects/KAster_CTI/.codex/get-shit-done/USER-PROFILE.md" "D:/Work/AI_Projects/KAster_CTI/.codex/USER-PROFILE.backup.md"
```
...
✓ Stores profile at D:/Work/AI_Projects/KAster_CTI/.codex/get-shit-done/USER-PROFILE.md
...
- The user-profiling reference doc at `D:/Work/AI_Projects/KAster_CTI/.codex/get-shit-done/references/user-profiling.md`
...
Reference: @D:/Work/AI_Projects/KAster_CTI/.codex/get-shit-done/references/user-profiling.md
...
Display: "✓ Profile written to D:/Work/AI_Projects/KAster_CTI/.codex/get-shit-done/USER-PROFILE.md"
...
- options (ALL pre-selected by default):
  ...
  - "Global AGENTS.md" -- "Add profile to D:/Work/AI_Projects/KAster_CTI/.codex/AGENTS.md for all projects"

**If no artifacts selected:** Display "No artifacts generated. Your profile is saved at D:/Work/AI_Projects/KAster_CTI/.codex/get-shit-done/USER-PROFILE.md" and jump to step 10.
...
Display: "✓ Generated $gsd-dev-preferences at D:/Work/AI_Projects/KAster_CTI/.codex/commands/gsd/dev-preferences.md"
...
Display: "✓ Added profile section to D:/Work/AI_Projects/KAster_CTI/.codex/AGENTS.md"
...
```bash
BACKUP_PATH="D:/Work/AI_Projects/KAster_CTI/.codex/USER-PROFILE.backup.md"
```
...
Your profile:    D:/Work/AI_Projects/KAster_CTI/.codex/get-shit-done/USER-PROFILE.md
```

Then list paths for each generated artifact:
```
Artifacts:
  ✓ $gsd-dev-preferences   D:/Work/AI_Projects/KAster_CTI/.codex/commands/gsd/dev-preferences.md
  ✓ AGENTS.md section       ./AGENTS.md
  ✓ Global AGENTS.md        D:/Work/AI_Projects/KAster_CTI/.codex/AGENTS.md
```
