...
<required_reading>
@D:/Work/AI_Projects/KAster_CTI/.codex/get-shit-done/references/domain-probes.md
@D:/Work/AI_Projects/KAster_CTI/.codex/get-shit-done/references/gate-prompts.md
@D:/Work/AI_Projects/KAster_CTI/.codex/get-shit-done/references/universal-anti-patterns.md
</required_reading>
...
- Read and execute @D:/Work/AI_Projects/KAster_CTI/.codex/get-shit-done/workflows/discuss-phase-power.md end-to-end
...
```bash
PROFILE_CONTENT=$(cat "D:/Work/AI_Projects/KAster_CTI/.codex/get-shit-done/USER-PROFILE.md" 2>/dev/null || true)
```
...
2. For EACH user-selected gray area, spawn a Task() in parallel:
   ...
   Task(
     prompt="First, read @D:/Work/AI_Projects/KAster_CTI/.codex/agents/gsd-advisor-researcher.md for your role and instructions.
...
**Full step-by-step instructions:** @D:/Work/AI_Projects/KAster_CTI/.codex/get-shit-done/workflows/discuss-phase-power.md
