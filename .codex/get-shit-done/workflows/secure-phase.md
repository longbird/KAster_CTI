...
```
Task(
  prompt="Read D:/Work/AI_Projects/KAster_CTI/.codex/agents/gsd-security-auditor.md for instructions.\n\n" +
...
**State B (create):**
1. Read template from `D:/Work/AI_Projects/KAster_CTI/.codex/get-shit-done/templates/SECURITY.md`
