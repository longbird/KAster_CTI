...
<template>
@D:/Work/AI_Projects/KAster_CTI/.codex/get-shit-done/templates/UAT.md
</template>
...
Read and follow `D:/Work/AI_Projects/KAster_CTI/.codex/get-shit-done/workflows/transition.md`.
...
```bash
node "D:/Work/AI_Projects/KAster_CTI/.codex/get-shit-done/bin/gsd-tools.cjs" audit-open --json 2>/dev/null
```
...
- Follow @D:/Work/AI_Projects/KAster_CTI/.codex/get-shit-done/workflows/diagnose-issues.md
