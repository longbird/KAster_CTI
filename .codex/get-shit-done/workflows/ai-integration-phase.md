...
<required_reading>
@D:/Work/AI_Projects/KAster_CTI/.codex/get-shit-done/references/ai-frameworks.md
@D:/Work/AI_Projects/KAster_CTI/.codex/get-shit-done/references/ai-evals.md
</required_reading>
...
```markdown
Read D:/Work/AI_Projects/KAster_CTI/.codex/agents/gsd-framework-selector.md for instructions.
...
Copy template:
```bash
cp "D:/Work/AI_Projects/KAster_CTI/.codex/get-shit-done/templates/AI-SPEC.md" "${PHASE_DIR}/${PADDED_PHASE}-AI-SPEC.md"
```
...
```markdown
Read D:/Work/AI_Projects/KAster_CTI/.codex/agents/gsd-ai-researcher.md for instructions.
...
```markdown
Read D:/Work/AI_Projects/KAster_CTI/.codex/agents/gsd-domain-researcher.md for instructions.
...
```markdown
Read D:/Work/AI_Projects/KAster_CTI/.codex/agents/gsd-eval-planner.md for instructions.
