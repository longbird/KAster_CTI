...
```bash
INIT=$(node "D:/Work/AI_Projects/KAster_CTI/.codex/get-shit-done/bin/gsd-tools.cjs" init phase-op "${PHASE}")
...
Use the SPEC.md template from @D:/Work/AI_Projects/KAster_CTI/.codex/get-shit-done/templates/spec.md.
