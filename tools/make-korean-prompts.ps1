...
$prompts = @(
  ...
  @{ f = 'smart080_guide';        t = '수신 거부 등록 서비스입니다.' }
  @{ f = 'smart080_input';        t = '수신 거부하실 전화번호를 누르신 후, 우물 정자를 눌러 주세요.' }
  @{ f = 'smart080_reentry';      t = '번호를 다시 눌러 주신 후, 우물 정자를 눌러 주세요.' }
  @{ f = 'smart080_confirm_menu'; t = '등록하시려면 일번, 번호를 다시 입력하시려면 이번, 종료하시려면 구번을 눌러 주세요.' }
  @{ f = 'smart080_same_number';  t = '발신하신 번호와 동일합니다. 등록하실 번호를 다시 눌러 주세요.' }
