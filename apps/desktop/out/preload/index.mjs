...
const desktopApi = {
  ...
  getCallPreferences: () => ipcRenderer.invoke("desktop:get-call-preferences"),
  saveCallPreferences: (input) => ipcRenderer.invoke("desktop:save-call-preferences", input),
  getGeneralPreferences: () => ipcRenderer.invoke("desktop:get-general-preferences"),
  saveGeneralPreferences: (input) => ipcRenderer.invoke("desktop:save-general-preferences", input),
  getTransferHotkeys: () => ipcRenderer.invoke("desktop:get-transfer-hotkeys"),
  saveTransferHotkeys: (input) => ipcRenderer.invoke("desktop:save-transfer-hotkeys", input),
  ...
  changeAgentStatus: (agentId, statusCode, reasonCode) => ipcRenderer.invoke("desktop:change-agent-status", agentId, statusCode, reasonCode),
