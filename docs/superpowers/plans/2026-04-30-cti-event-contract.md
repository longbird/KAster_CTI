...
- Create: `docs/cti-event-contract.md`
...
Create `docs/cti-event-contract.md` with these sections:
...
**Files:**
- Modify: `docs/cti-event-contract.md`
- Modify: `docs/project-next-tasks.md`

- [ ] **Step 1: Add current mismatch notes**

Add a "현재 차이와 후속 작업" section to `docs/cti-event-contract.md`:
...
In `docs/project-next-tasks.md`, under `## 1. P0: 실시간 이벤트 계약 정합화`, add:
