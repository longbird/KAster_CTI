...
**헤드셋 조건은 실측으로 닫혔다. 스피커폰 조건만 남았다.**
2026-08-21 상담원 PC 에 USB 헤드셋이 붙어 실 PBX 를 상대로 양방향 음성·왕복 지연·에코·음소거를 모두 측정했다.
...
| 헤드셋 에코 | **통과** | 지연 배수 자리에 봉우리 없음 (9-3장) |
| 음소거가 상대에게 반영 | **통과** | 되돌아온 소리 −25.4 → −55.7 dBFS (9-4장) |
| **스피커폰 에코** | **미검증** | 이 PC 에 내장 스피커·마이크가 없어 조건을 만들 수 없다 |
