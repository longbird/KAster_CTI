...
작성일: 2026-04-30
기준 문서: `docs/project-integrated-plan.md`
...
- `docs/project-integrated-plan.md`를 현재 운영 기준 문서로 확정한다.
...
- `docs/superpowers/plans/2026-04-30-cti-event-contract.md`
- `docs/superpowers/plans/2026-04-30-realtime-event-scope.md`
- `docs/cti-event-contract.md`
...
- 관리자 앱 실시간 이벤트 소비 계획: `docs/superpowers/plans/2026-04-30-admin-realtime-consumption.md`
...
- `docs/superpowers/plans/2026-04-30-call-control-state-sync.md`
...
- 설정 반영 runbook: `docs/design/pbx-config-apply-runbook.md`
...
- 운영 배포 표준: `docs/design/production-deployment-standard.md`
...
- 실환경 테스트 runbook: `docs/design/agent-desktop-live-test-runbook.md`
