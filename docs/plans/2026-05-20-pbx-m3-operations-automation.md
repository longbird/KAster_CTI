...
```bash
git add docs/plans/2026-05-20-pbx-m3-operations-automation.md apps/server
...
git add docs/plans/2026-05-20-pbx-m3-operations-automation.md apps/server apps/admin
...
- Modify: `docs/plans/pbx-selected-features-development-plan-20260514.md`
