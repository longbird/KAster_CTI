...
- 상위 계획서: `docs/plans/pbx-selected-features-development-plan-20260514.md` (섹션 "공통 도움말 기능 개발 계획")
...
- 입력 자료:
  ...
  - `docs/reference/IPPBX_개발시 참조용_20260104/3_DM_설정화면/` (MMC 설정화면 PNG 27장)
