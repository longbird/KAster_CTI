...
> 후속 문서: [`docs/qa/2026-08-09-requirements-vs-implementation-verification.md`](../qa/2026-08-09-requirements-vs-implementation-verification.md)
> — 원본 엑셀의 MMC 42건을 항목 단위로 추적하고 IPCC 우선순위·설계문서 계약축까지 포함한 2026-08-09 기준 평가표.
> 이 문서는 2026-07-16 시점의 기능 단위 판단으로 유지한다.
